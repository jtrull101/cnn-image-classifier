...
class TestApiEndpoints:
    ...
    def test_load_model_endpoint(self, mock_load, client):
    ...
    @patch("img_classifier_api.app.model_manager.load_model")
    def test_load_model_endpoint_file_not_found(self, mock_load, client):
    ...
    @patch("img_classifier_api.app.model_manager.load_model")
    def test_load_model_endpoint_error(self, mock_load, client):
